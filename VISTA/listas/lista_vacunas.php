<?php 
include_once('../CONTROL/c_vacuna.php'); #controlador
?>

<div class="titulo_m">
	<h2>Lista de vacunas</h2><i class="icon-th-list"></i>
</div>
...
<div class="marginB05rem">
	<div class="left">
		...
		<!-- agregar -->
		<?php if( $sI == '1' ){?>
		<div class="btn btn_icon_split btn_normal btn_verde btn_md" id="open-W-form"><i class="icon-plus"></i><p>Agregar Vacuna</p></div>
		<?php } ?>
	</div>
...
<div class="caja">
	<table class="tabla3" width="96%" cellspacing="0" id="resultados">
	 	...
	 	<?php listar_vcna(); #ver c_vacuna.php?>
	</table>
	
	<!-- Ventana Formulario se agrega a id="window-cont-formulario" de index.php ver: ventanas.js -->
	<div id="form-vcna" class="W-form">
		<!-- formulario vacuna -->
		<form name="f_vacuna" method="POST" action="../CONTROL/c_vacuna.php">
			<input type="hidden" name="ope"/>
			<input type="hidden" name="cod"/>

			<div class="W-top">
				 <h3 class="W-nom" id="W-nom"><i class="icon-plus"></i>Agregar vacuna</h3>
			...
			<div class="W-body">
				...
				<p id="aviso" class="msj_aviso tx_sm none"><b>Advertencia: </b> Si elimina ésta vacuna también se eliminará<br/>la relación con el estudiante. ¿Desea continuar?</p>
			</div>
			<!-- botones -->
			<div class="W-bottom">
...
<div class="clear"></div>
<script type="text/javascript" src="../JAVASCRIPT/l_vacuna.js"></script>
